...
std::vector <std::string> nomi{ "Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno","Alunno" };
    ...
    while (std::getline(file, x)) {
        ...
        if (linea == 27) {
            if (x[2] == 48) {
                ...
                numero_estrazioni=x[2] - 48;
            }
            else {
                numero_estrazioni=(x[2] - 48) * 10 + x[3] - 48;
            }
            break;
        }
        if (x[2] == 48) {
